            ...
            <div class="overflow-x-auto mt-3 bg-[#FEEEBD] p-5 rounded-md">
                <table class="bg-white shadow-md">
                    ...
                    <tr class="bg-blue-gray-100 text-gray-700">
                        ...
                        <th class="py-3 px-12 text-center text-white border border-orange-300">Deskripsi</th>
                        <th class="py-3 px-12 text-center text-white border border-orange-300">Jumlah Anggota</th>
                    ...
                    <tr class="border-separate border border-[#CFAD82] bg-[#FFE28B]">
                        ...
                        <td class="py-3 px-4 border border-[#CFAD82] text-center">{{ $tree->description ?? 'data kosong' }}</td>
